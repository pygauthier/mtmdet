...
$Surname = Read-Host "Préfix de la boite (Ex: _R DGTI): "
$Given = Read-Host "Sufix de la boite (Ex: Vehicule 28-456): "
$samaccount = Read-Host "Code NT de la boite (Ex: cr-dgti00-Vehicule28456): "
...
if($setad -eq "oui"){
    ...
    Set-aduser $samaccount -Title "Ressource"
...
Set-Mailbox $samaccount -Type Equipment
