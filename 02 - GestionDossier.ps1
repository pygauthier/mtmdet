...
1.9.2 Ajout de l'utilisateur dans son groupe D-MTQ000-G-Intranet_MonUnite-**** - 2017/08/01 Francis Trudel
#>
...
Switch($Menu){
    ...
    1 { 
            ...
            #Recherche numéro d'UA 

            #Extraction de la longString
            ...
            $g =  Get-ADGroupMember -Identity $groupe | select -ExpandProperty sAMAccountName
